...
**Supported Targets:** ESP32, ESP8266, ESP32-C2, ESP32-C3, ESP32-C5, ESP32-C6, ESP32-C61, ESP32-S2, ESP32-S3

### Network Provisioning

The example uses configurable network provisioning to connect to WiFi. You can choose between:
...
3. **Use a BLE provisioning app** (like ESP RainMaker on Android/iOS) to scan the QR code or manually enter:
   - **Device Name**: ESP-Schedule-XXXX (unique MAC-based name)
...
**SoftAP Provisioning:**
1. **Flash and run** the example on your ESP device
2. **The device creates a WiFi hotspot** (ESP-Schedule-XXXX - unique MAC-based name)
3. **Connect to the hotspot** using password "password"
4. **Open a web browser** and go to http://192.168.4.1
5. **Enter your WiFi credentials** and **Proof of Possession (PoP)**: 12345678
6. **The device will connect** to your WiFi and synchronize time

The provisioning scheme can be selected via the project configuration menu.
